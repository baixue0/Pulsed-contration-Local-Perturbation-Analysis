...
% Compute 1-D unstable manifold
    ...
    global manifold_extend
    
    manifold_extend = struct();
    manifold_extend.Arc = Arc;
    manifold_extend.M = M;
    manifold_extend.NMax = NMax;
    manifold_extend.Npoint = Npoint;
    manifold_extend.PreImage = PreImage;
    manifold_extend.alphak = alphak;
    manifold_extend.alphamax = alphamax;
    manifold_extend.alphamin = alphamin;
    manifold_extend.arcl = arcl;
    manifold_extend.bisecIndex = bisecIndex;
    manifold_extend.bisection = bisection;
    manifold_extend.delInit = delInit;
    manifold_extend.deltaalphamax = deltaalphamax;
    manifold_extend.deltaalphamin = deltaalphamin;
    manifold_extend.deltak = deltak;
    manifold_extend.deltamax = deltamax;
    manifold_extend.deltamin = deltamin;
    manifold_extend.distR = distR;
    manifold_extend.distance = distance;
    manifold_extend.eps = eps;
    manifold_extend.epsb = epsb;
    manifold_extend.fun_eval = fun_eval;
    manifold_extend.i = i;
    manifold_extend.jacobian = jacobian;
    manifold_extend.man_ds = man_ds;
    manifold_extend.newPoint = newPoint;
    manifold_extend.opt_man = opt_man;
    manifold_extend.p0 = p0;
    manifold_extend.param = param;
    manifold_extend.pk = pk;
    manifold_extend.q = q;
    manifold_extend.qL = qL;
    manifold_extend.qR = qR;
    manifold_extend.v = v;
